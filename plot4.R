###############################################################
##
## plot3.R   - Program for the 4th plot of the Course Project 1
...
## make plot with the PNG device
png("plot4.png",width = 480,height = 480)

## Choose 2x2 plot arrangement, fill by columns first
par(mfcol=c(2,2))

## Copy the code from plot2.R for GAP over Time plot (with shorter y-axis label)
plot(data$Time,data$Global_active_power,type="l",xlab="",ylab="Global Active Power")

## Copy the code from plot3.R for ESM over Time plot (with no border around legend)
